/**************************************************************************
File:               evro_int_evro_int_evro_16di_.c
Author:             umputun
...
#include <dsys0def.h>
#include <dios0def.h>
#include <evro_int_evro_int_evro_16di_.h>
...
/****************************************************************************
function    : evro_int_evro_int_evro_16di_IosOpen
...
)
{
    ...
    if (evro_int_evro_int_evro_16dirIosOpen(pRtIoSplDvc) != 0)
    {
        printf("Error opening\n");
        return(BAD_RET);
    }
...
/****************************************************************************
function    : evro_int_evro_int_evro_16di_IosClose
...
)
{
    strRtIoSplDvc* pRtIoSplDvc;
    pRtIoSplDvc = pvRtIoDvc->pRtIoSplDvc;
    evro_int_evro_int_evro_16diIosClose (pRtIoSplDvc);
    pRtIoSplDvc = (strRtIoSplDvc*)(pRtIoSplDvc->pvDrvRtIoDvcNxt);
    evro_int_evro_int_evro_16dirIosClose(pRtIoSplDvc);
    pRtIoSplDvc = (strRtIoSplDvc*)(pRtIoSplDvc->pvDrvRtIoDvcNxt);
    evro_int_evro_int_status_mIosClose(pRtIoSplDvc);
}

/****************************************************************************
function    : evro_int_evro_int_evro_16di_evro_16diIosRead
...
/****************************************************************************
function    : evro_int_evro_int_evro_16di_evro_16diIosCtl
...
/****************************************************************************
function    : evro_int_evro_int_evro_16di_evro_16dirIosRead
description : Simple device Read function
parameters  :
   (input) void* pvRtIoDvc :  Run time io struct of the device to read
return value: None
...
/****************************************************************************
function    : evro_int_evro_int_evro_16di_evro_16dirIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
...
/****************************************************************************
function    : evro_int_evro_int_evro_16di_status_mIosRead
description : Simple device Read function
parameters  :
   (input) void* pvRtIoDvc :  Run time io struct of the device to read
return value: None
...
/****************************************************************************
function    : evro_int_evro_int_evro_16di_status_mIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
