/**************************************************************************
File:               evro_int_evro_int_evro_16do_.h
Author:             umputun
Creation date:      21/07/2012 - 20:05
Device name:        EVRO_16do_
***************************************************************************/

#ifndef _EVRO_INT_EVRO_INT_EVRO_16do__H /* nested Headers management */
#define _EVRO_INT_EVRO_INT_EVRO_16do__H
...
typSTATUS evro_int_evro_int_evro_16do_IosMdf
(
    uchar          cuSubFunc,   /* Sub function switch */
...
typSTATUS evro_int_evro_int_evro_16do_evro_16doIosMdf
(
    uchar          cuSubFunc,  /* Sub function switch */
...
typSTATUS evro_int_evro_int_evro_16do_status_mIosMdf
(
    uchar          cuSubFunc,  /* Sub function switch */
    strRtIoSplDvc* pRtIoSplDvc,/* Simple device run time io struct */
    uint32         luMdfType,  /* On line modification types */
...
#endif /* _EVRO_INT_EVRO_INT_EVRO_16do__H */
