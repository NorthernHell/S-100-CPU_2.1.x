/**************************************************************************
File:               evro_tcpc_evro_tcpc_modbus_tcp_client_ao_float.c
Author:             Umputun
...
#include <dsys0def.h>
#include <dios0def.h>
#include <evro_tcpc_evro_tcpc_modbus_tcp_client_ao_float.h>
...
typedef struct _tag_strModbus_tcp_client_ao_float
{
    char   IP[16];
    int32  PORT;
    int32  Adress;
    ...
    int32  TimeOutsec;
    int32  TimeOutTCP;
} strModbus_tcp_client_ao_float;


/****************************************************************************
function    : evro_tcpc_evro_tcpc_modbus_tcp_client_ao_floatIosOpen
...
)
{
    ...
    if (evro_tcpc_evro_tcpc_mtcp_ao_floatIosOpen (pRtIoSplDvc) != 0)
    {
...
/****************************************************************************
function    : evro_tcpc_evro_tcpc_modbus_tcp_client_ao_floatIosClose
...
)
{
    strRtIoSplDvc* pRtIoSplDvc;
    pRtIoSplDvc = pvRtIoDvc->pRtIoSplDvc;
    evro_tcpc_evro_tcpc_mtcp_ao_floatIosClose (pRtIoSplDvc);
    pRtIoSplDvc = (strRtIoSplDvc*)(pRtIoSplDvc->pvDrvRtIoDvcNxt);
    evro_tcpc_evro_tcpc_modbus_tcp_statusIosClose(pRtIoSplDvc);
}

/****************************************************************************
function    : evro_tcpc_evro_tcpc_modbus_tcp_client_ao_floatmodbus_tcp_statusIosRead
...
/****************************************************************************
function    : evro_tcpc_evro_tcpc_modbus_tcp_client_ao_floatmodbus_tcp_statusIosCtl
...
/****************************************************************************
function    : evro_tcpc_evro_tcpc_modbus_tcp_client_ao_floatmtcp_ao_floatIosWrite
...
{
    evro_tcpc_evro_tcpc_mtcp_ao_floatIosWrite(pRtIoSplDvc);
}

/****************************************************************************
function    : evro_tcpc_evro_tcpc_modbus_tcp_client_ao_floatmtcp_ao_floatIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
...
{
    evro_tcpc_evro_tcpc_mtcp_ao_floatIosCtl(cuSubFunct,pRtIoSplDvc,huChanNum,pvReserved);
}
