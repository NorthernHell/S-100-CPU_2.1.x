/**************************************************************************
File:               evro_tcpc_evro_tcpc_modbus_tcp_status.h
Author:             Umputun
Creation date:      25/02/2013 - 16:08
Device name:        MODBUS_TCP_STATUS
***************************************************************************/

#ifndef _EVRO_TCPC_EVRO_TCPC_MODBUS_TCP_STATUS_H /* nested Headers management */
#define _EVRO_TCPC_EVRO_TCPC_MODBUS_TCP_STATUS_H
...
typSTATUS evro_tcpc_evro_tcpc_modbus_tcp_statusIosMdf
   (
   uchar          cuSubFunc,  /* Sub function switch */
...
#endif /* _EVRO_TCPC_EVRO_TCPC_MODBUS_TCP_STATUS_H */
