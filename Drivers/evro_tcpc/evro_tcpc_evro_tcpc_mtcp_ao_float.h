/**************************************************************************
File:               evro_tcpc_evro_tcpc_mtcp_ao_float.h
Author:             Umputun
Creation date:      25/02/2013 - 16:08
Device name:        MTCP_ao_float
***************************************************************************/

#ifndef _EVRO_TCPC_EVRO_TCPC_MTCP_AO_FLOAT_H /* nested Headers management */
#define _EVRO_TCPC_EVRO_TCPC_MTCP_AO_FLOAT_H
...
typSTATUS evro_tcpc_evro_tcpc_mtcp_ao_floatIosMdf
   (
   uchar          cuSubFunc,  /* Sub function switch */
...
#endif /* _EVRO_TCPC_EVRO_TCPC_MTCP_AO_FLOAT_H */
