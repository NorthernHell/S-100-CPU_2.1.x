/**************************************************************************
File:               evro_ext_evro_ext_io_8dio.c
Author:             Umputun
...
#include <dsys0def.h>
#include <dios0def.h>
#include <evro_ext_evro_ext_io_8dio.h>
#include <evro_ext_evro_ext_io8di.h>
#include <evro_ext_evro_ext_io8do.h>
...
typedef struct _tag_strIo_8dio
{
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8dioIosOpen
...
)
{
    ...
    if (evro_ext_evro_ext_io8diIosOpen (pRtIoSplDvc) != 0)
    {
        printf("Error opening\n");
        return(BAD_RET);
    }
    pRtIoSplDvc = (strRtIoSplDvc*)(pRtIoSplDvc->pvDrvRtIoDvcNxt);	
    if (evro_ext_evro_ext_io8doIosOpen (pRtIoSplDvc) != 0)
    {
        printf("Error opening\n");
        return(BAD_RET);
    }
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8dioIosClose
...
)
{
    strRtIoSplDvc* pRtIoSplDvc;
    pRtIoSplDvc = pvRtIoDvc->pRtIoSplDvc;
    evro_ext_evro_ext_io8diIosClose (pRtIoSplDvc);
    pRtIoSplDvc = (strRtIoSplDvc*)(pRtIoSplDvc->pvDrvRtIoDvcNxt);
    evro_ext_evro_ext_io8doIosClose (pRtIoSplDvc);
    pRtIoSplDvc = (strRtIoSplDvc*)(pRtIoSplDvc->pvDrvRtIoDvcNxt);	
    evro_ext_evro_ext_modbusstatusIosClose(pRtIoSplDvc);
}

/****************************************************************************
function    : evro_ext_evro_ext_io_8dioio8diIosRead
...
)
{
     ...
     * channels are locked.
     */
    evro_ext_evro_ext_io8diIosRead(pRtIoSplDvc);

}

/****************************************************************************
function    : evro_ext_evro_ext_io_8dioio8diIosCtl
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8dioio8doIosWrite
description : Simple device Read function
parameters  :
   (input) void* pvRtIoDvc :  Run time io struct of the device to read
return value: None
...
)
{
     ...
     * channels are locked.
     */
    evro_ext_evro_ext_io8doIosWrite(pRtIoSplDvc);

}

/****************************************************************************
function    : evro_ext_evro_ext_io_8dioio8doIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8diomodbusstatusIosRead
description : Simple device Read function
parameters  :
   (input) void* pvRtIoDvc :  Run time io struct of the device to read
return value: None
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8diomodbusstatusIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
