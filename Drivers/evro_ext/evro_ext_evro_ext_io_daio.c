/**************************************************************************
File:               evro_ext_evro_ext_io_daio.c
Author:             Umputun
...
#include <dsys0def.h>
#include <dios0def.h>
#include <evro_ext_evro_ext_io_daio.h>
#include <evro_ext_evro_ext_io4di.h>
#include <evro_ext_evro_ext_io2do.h>
#include <evro_ext_evro_ext_io2rtd.h>
#include <evro_ext_evro_ext_io2ai.h>
#include <evro_ext_evro_ext_io1ao.h>
...
typedef struct _tag_strIo_daio
{
...
/****************************************************************************
function    : evro_ext_evro_ext_io_daioIosOpen
...
)
{
    ...
    if (evro_ext_evro_ext_io4diIosOpen (pRtIoSplDvc) != 0)
    {
...
/****************************************************************************
function    : evro_ext_evro_ext_io_daioIosClose
...
)
{
    strRtIoSplDvc* pRtIoSplDvc;
    pRtIoSplDvc = pvRtIoDvc->pRtIoSplDvc;
    evro_ext_evro_ext_io4diIosClose (pRtIoSplDvc);
    pRtIoSplDvc = (strRtIoSplDvc*)(pRtIoSplDvc->pvDrvRtIoDvcNxt);
    evro_ext_evro_ext_io2doIosClose (pRtIoSplDvc);
    pRtIoSplDvc = (strRtIoSplDvc*)(pRtIoSplDvc->pvDrvRtIoDvcNxt);
    evro_ext_evro_ext_io2rtdIosClose (pRtIoSplDvc);
    pRtIoSplDvc = (strRtIoSplDvc*)(pRtIoSplDvc->pvDrvRtIoDvcNxt);
...
/****************************************************************************
function    : evro_ext_evro_ext_io_daioio4diIosRead
...
)
{
     ...
     * channels are locked.
     */
    evro_ext_evro_ext_io4diIosRead(pRtIoSplDvc);

}

/****************************************************************************
function    : evro_ext_evro_ext_io_daioio4diIosCtl
...
/****************************************************************************
function    : evro_ext_evro_ext_io_daioio2doIosWrite
description : Simple device Read function
parameters  :
   (input) void* pvRtIoDvc :  Run time io struct of the device to read
return value: None
...
)
{
     ...
     * channels are locked.
     */
    evro_ext_evro_ext_io2doIosWrite(pRtIoSplDvc);

}

/****************************************************************************
function    : evro_ext_evro_ext_io_daioio2doIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
...
/****************************************************************************
function    : evro_ext_evro_ext_io_daioio2rtdIosRead
description : Simple device Read function
parameters  :
   (input) void* pvRtIoDvc :  Run time io struct of the device to read
return value: None
...
)
{
     ...
     * channels are locked.
     */
    evro_ext_evro_ext_io2rtdIosRead(pRtIoSplDvc);

}

/****************************************************************************
function    : evro_ext_evro_ext_io_daioio2rtdIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
...
/****************************************************************************
function    : evro_ext_evro_ext_io_daioio2aiIosRead
description : Simple device Read function
parameters  :
   (input) void* pvRtIoDvc :  Run time io struct of the device to read
return value: None
...
)
{
     ...
     * channels are locked.
     */
    evro_ext_evro_ext_io2aiIosRead(pRtIoSplDvc);

}

/****************************************************************************
function    : evro_ext_evro_ext_io_daioio2aiIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
...
/****************************************************************************
function    : evro_ext_evro_ext_io_daioio1aoIosWrite
description : Simple device Read function
parameters  :
   (input) void* pvRtIoDvc :  Run time io struct of the device to read
return value: None
...
)
{
     ...
     * channels are locked.
     */
    evro_ext_evro_ext_io1aoIosWrite(pRtIoSplDvc);

}

/****************************************************************************
function    : evro_ext_evro_ext_io_daioio1aoIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
...
/****************************************************************************
function    : evro_ext_evro_ext_io_daiomodbusstatusIosRead
description : Simple device Read function
parameters  :
   (input) void* pvRtIoDvc :  Run time io struct of the device to read
return value: None
...
/****************************************************************************
function    : evro_ext_evro_ext_io_daiomodbusstatusIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
