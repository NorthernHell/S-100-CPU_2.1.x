/**************************************************************************
File:               evro_ext_evro_ext_io_8tcs.c
Author:             Umputun
...
#include <dsys0def.h>
#include <dios0def.h>
#include <evro_ext_evro_ext_io_8tcs.h>
...
typedef struct _tag_strIo_8tcs
{
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8tcsIosOpen
...
)
{
    ...
    if (evro_ext_evro_ext_io8tcsIosOpen (pRtIoSplDvc) != 0)
    {
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8tcsIosClose
...
)
{
    strRtIoSplDvc* pRtIoSplDvc;
    pRtIoSplDvc = pvRtIoDvc->pRtIoSplDvc;
    evro_ext_evro_ext_io8tcsIosClose (pRtIoSplDvc);
    pRtIoSplDvc = (strRtIoSplDvc*)(pRtIoSplDvc->pvDrvRtIoDvcNxt);
    evro_ext_evro_ext_modbusstatusIosClose(pRtIoSplDvc);
}

/****************************************************************************
function    : evro_ext_evro_ext_io_8tcsio8tcsIosRead
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8tcsio8tcsIosCtl
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8tcsmodbusstatusIosRead
description : Simple device Read function
parameters  :
   (input) void* pvRtIoDvc :  Run time io struct of the device to read
return value: None
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8tcsmodbusstatusIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
