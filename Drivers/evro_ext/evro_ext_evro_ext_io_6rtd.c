/**************************************************************************
File:               evro_ext_evro_ext_io_6rtd.c
Author:             Umputun
...
#include <dsys0def.h>
#include <dios0def.h>
#include <evro_ext_evro_ext_io_6rtd.h>
...
typedef struct _tag_strIo_6rtd
{
...
/****************************************************************************
function    : evro_ext_evro_ext_io_6rtdIosOpen
...
)
{
    ...
    if (evro_ext_evro_ext_io6rtdIosOpen (pRtIoSplDvc) != 0)
    {
...
/****************************************************************************
function    : evro_ext_evro_ext_io_6rtdIosClose
...
)
{
    strRtIoSplDvc* pRtIoSplDvc;
    pRtIoSplDvc = pvRtIoDvc->pRtIoSplDvc;
    evro_ext_evro_ext_io6rtdIosClose (pRtIoSplDvc);
    pRtIoSplDvc = (strRtIoSplDvc*)(pRtIoSplDvc->pvDrvRtIoDvcNxt);
    evro_ext_evro_ext_modbusstatusIosClose(pRtIoSplDvc);
}

/****************************************************************************
function    : evro_ext_evro_ext_io_6rtdio6rtdIosRead
...
)
{
     ...
     * channels are locked.
     */
    evro_ext_evro_ext_io6rtdIosRead(pRtIoSplDvc);

}

/****************************************************************************
function    : evro_ext_evro_ext_io_6rtdio6rtdIosCtl
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8aimodbusstatusIosRead
description : Simple device Read function
parameters  :
   (input) void* pvRtIoDvc :  Run time io struct of the device to read
return value: None
...
/****************************************************************************
function    : evro_ext_evro_ext_io_8aimodbusstatusIosCtl
description : Simple device Control function
parameters  :
   (input) uchar cuSubFunct :          Sub function parameter.
   (input) strRtIoSplDvc* pRtIoSplDvc: Rt io struct of the spl dvc to control.
