/**************************************************************************
File:               evro_ext_evro_ext_io8do.c
Author:             Umputun
...
/****************************************************************************
function    : evro_ext_evro_ext_io8doIosOpen
...
/****************************************************************************
function    : evro_ext_evro_ext_io8doIosClose
...
/****************************************************************************
function    : evro_ext_evro_ext_io8doIosWrite
...
)
{
    ...
    {
        modbus_set_response_timeout(ctx, &response_timeout);
        rc  = modbus_write_bits(ctx, 16, nbChannel, sNewMsg);
 		if (rc == -1)
        {
            cpxDev->luUser =0;
        }
...
/****************************************************************************
function    : evro_ext_evro_ext_io8doIosCtl
