/**************************************************************************
File:               evro_ext_evro_ext_io4di.c
Author:             Umputun
...
/****************************************************************************
function    : evro_ext_evro_ext_io4diIosOpen
...
)
{
    ...
    else
    {
        ...
        rc = modbus_write_register(ctx, 102, oemCPar->Input_Filter);
		if (rc == -1)
        {
            cpxDev->luUser =0;
        }
...
/****************************************************************************
function    : evro_ext_evro_ext_io4diIosClose
...
/****************************************************************************
function    : evro_ext_evro_ext_io4diIosRead
...
)
{
    ...
    {
        modbus_set_response_timeout(ctx, &response_timeout);
        rc= modbus_read_input_bits(ctx, 0, 4, tab_reg);
		if (rc == -1)
        {
            cpxDev->luUser =0;
        }
...
/****************************************************************************
function    : evro_ext_evro_ext_io4diIosCtl
