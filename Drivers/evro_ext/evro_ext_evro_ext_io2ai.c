/**************************************************************************
File:               evro_ext_evro_ext_io2ai.c
Author:             Umputun
...
/****************************************************************************
function    : evro_ext_evro_ext_io2aiIosOpen
...
)
{
    ...
    else
    {
        ...
        rc = modbus_write_register(ctx, 105, oemCPar->AI_type_ch1);
        if (rc == -1)
        {
            cpxDev->luUser =0;
        }
        ...
        modbus_set_response_timeout(ctx, &response_timeout);
        rc = modbus_write_register(ctx, 106, oemCPar->AI_type_ch1);
        if (rc == -1)
        {
            cpxDev->luUser =0;
        }
...
/****************************************************************************
function    : evro_ext_evro_ext_io2aiIosClose
...
/****************************************************************************
function    : evro_ext_evro_ext_io2aiIosRead
...
)
{
    ...
    {
        modbus_set_response_timeout(ctx, &response_timeout);
        rc  = modbus_read_registers(ctx, 5, 2, tab_reg);
        modbus_close(ctx);
        modbus_free(ctx);
        if (rc == -1)
        {
...
/****************************************************************************
function    : evro_ext_evro_ext_io2aiIosCtl
