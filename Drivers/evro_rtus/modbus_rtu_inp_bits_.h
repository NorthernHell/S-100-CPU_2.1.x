/**************************************************************************
File:               modbus_rtu_inp_bits_.h
Author:             Umputun
Creation date:      20/02/2013 - 12:46
Device name:        MODBUS_RTU_INP_BITS_
***************************************************************************/

#ifndef _MODBUS_RTU_INP_BITS__H /* nested Headers management */
#define _MODBUS_RTU_INP_BITS__H
...
typSTATUS _evro_rtus_evro_rtusmodbus_rtu_inp_bits_IosMdf
   (
   uchar          cuSubFunc,  /* Sub function switch */
