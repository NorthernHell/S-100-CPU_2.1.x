/**************************************************************************
File:               modbus_rtu_holding_o_.h
Author:             Umputun
Creation date:      20/02/2013 - 12:46
Device name:        MODBUS_RTU_HOLDING_O_
***************************************************************************/

#ifndef _MODBUS_RTU_HOLDING_O__H /* nested Headers management */
#define _MODBUS_RTU_HOLDING_O__H
...
typSTATUS _evro_rtus_evro_rtusmodbus_rtu_holding_o_IosMdf
   (
   uchar          cuSubFunc,  /* Sub function switch */
...
#endif /* _MODBUS_RTU_HOLDING_O__H */
