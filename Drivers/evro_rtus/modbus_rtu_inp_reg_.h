/**************************************************************************
File:               modbus_rtu_inp_reg_.h
Author:             Umputun
Creation date:      20/02/2013 - 12:46
Device name:        MODBUS_RTU_INP_REG_
***************************************************************************/

#ifndef _MODBUS_RTU_INP_REG__H /* nested Headers management */
#define _MODBUS_RTU_INP_REG__H
...
typSTATUS _evro_rtus_evro_rtusmodbus_rtu_inp_reg_IosMdf
   (
   uchar          cuSubFunc,  /* Sub function switch */
