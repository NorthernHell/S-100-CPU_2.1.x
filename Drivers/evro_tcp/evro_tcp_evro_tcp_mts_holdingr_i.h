/**************************************************************************
File:               evro_tcp_evro_tcp_mts_holdingr_i.h
Author:             Umputun
Creation date:      16/02/2013 - 20:17
Device name:        MTS_HOLDINGR_I
***************************************************************************/

#ifndef _EVRO_TCP_EVRO_TCP_MTS_HOLDINGR_I_H /* nested Headers management */
#define _EVRO_TCP_EVRO_TCP_MTS_HOLDINGR_I_H
...
typSTATUS evro_tcp_evro_tcp_mts_holdingr_iIosMdf
   (
   uchar          cuSubFunc,  /* Sub function switch */
...
#endif /* _EVRO_TCP_EVRO_TCP_MTS_HOLDINGR_I_H */
