/**************************************************************************
File:               evro_tcp_evro_tcp_mts_coil_o.h
Author:             Umputun
Creation date:      16/02/2013 - 20:17
Device name:        MTS_COIL_O
***************************************************************************/

#ifndef _EVRO_TCP_EVRO_TCP_MTS_COIL_O_H /* nested Headers management */
#define _EVRO_TCP_EVRO_TCP_MTS_COIL_O_H
...
typSTATUS evro_tcp_evro_tcp_mts_coil_oIosMdf
   (
   uchar          cuSubFunc,  /* Sub function switch */
...
#endif /* _EVRO_TCP_EVRO_TCP_MTS_COIL_O_H */
