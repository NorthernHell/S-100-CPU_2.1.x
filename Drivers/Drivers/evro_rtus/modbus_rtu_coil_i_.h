/**************************************************************************
File:               modbus_rtu_coil_i_.h
Author:             Umputun
Creation date:      20/02/2013 - 12:46
Device name:        MODBUS_RTU_COIL_I_
***************************************************************************/

#ifndef _MODBUS_RTU_COIL_I__H /* nested Headers management */
#define _MODBUS_RTU_COIL_I__H
...
typSTATUS _evro_rtus_evro_rtusmodbus_rtu_coil_i_IosMdf
   (
   uchar          cuSubFunc,  /* Sub function switch */
