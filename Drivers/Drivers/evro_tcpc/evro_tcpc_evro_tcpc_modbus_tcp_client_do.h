/**************************************************************************
File:               evro_tcpc_evro_tcpc_modbus_tcp_client_do.h
Author:             Umputun
Creation date:      25/02/2013 - 16:09
Device name:        MODBUS_TCP_CLIENT_DO
***************************************************************************/

#ifndef _EVRO_TCPC_EVRO_TCPC_MODBUS_TCP_CLIENT_DO_H /* nested Headers management */
#define _EVRO_TCPC_EVRO_TCPC_MODBUS_TCP_CLIENT_DO_H
...
typSTATUS evro_tcpc_evro_tcpc_modbus_tcp_client_doIosMdf
   (
   uchar          cuSubFunc,   /* Sub function switch */
...
typSTATUS evro_tcpc_evro_tcpc_modbus_tcp_client_domodbus_tcp_statusIosMdf
   (
   uchar          cuSubFunc,  /* Sub function switch */
...
typSTATUS evro_tcpc_evro_tcpc_modbus_tcp_client_domtcp_doIosMdf
   (
   uchar          cuSubFunc,  /* Sub function switch */
   strRtIoSplDvc* pRtIoSplDvc,/* Simple device run time io struct */
   uint32         luMdfType,  /* On line modification types */
...
#endif /* _EVRO_TCPC_EVRO_TCPC_MODBUS_TCP_CLIENT_DO_H */
