/**************************************************************************
File:               evro_tcpc_evro_tcpc_mtcp_di.h
Author:             Umputun
Creation date:      25/02/2013 - 16:08
Device name:        MTCP_DI
***************************************************************************/

#ifndef _EVRO_TCPC_EVRO_TCPC_MTCP_DI_H /* nested Headers management */
#define _EVRO_TCPC_EVRO_TCPC_MTCP_DI_H
...
typSTATUS evro_tcpc_evro_tcpc_mtcp_diIosMdf
   (
   uchar          cuSubFunc,  /* Sub function switch */
...
#endif /* _EVRO_TCPC_EVRO_TCPC_MTCP_DI_H */
